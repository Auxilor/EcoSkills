...
object ConditionAboveMagic : Condition<NoCompileData>("above_magic") {
    override val description = "Passes when the player's magic of the given type is at or above the minimum amount."
    ...
    override val arguments = arguments {
        ...
        require(
            ...
            description = "The minimum amount of magic required.",
