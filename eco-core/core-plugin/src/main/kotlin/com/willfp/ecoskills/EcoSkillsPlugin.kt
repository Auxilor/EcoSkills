...
class EcoSkillsPlugin : LibreforgePlugin() {
    ...
    override fun handleEnable() {
        ...
        Triggers.register(TriggerGainSkillXpAlchemy)
        Triggers.register(TriggerGainSkillXpCombat)
        Triggers.register(TriggerGainSkillXpEnchanting)
        Triggers.register(TriggerGainSkillXpFarming)
        Triggers.register(TriggerGainSkillXpFishing)
        Triggers.register(TriggerGainSkillXpForaging)
        Triggers.register(TriggerGainSkillXpMining)
